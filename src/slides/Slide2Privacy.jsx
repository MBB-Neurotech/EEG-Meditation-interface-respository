...
const CARDS = [
  ...
  },
  {
    ...
    title: 'EEG Data',
    body: 'EMOTIV Lite provides live wellness metrics for real-time demonstration only. No EEG data can be exported, stored, or accessed after your session ends.',
  },
  {
    icon: (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
